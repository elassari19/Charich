          ...
          <div className={cn('p-4 border rounded-md flex flex-col gap-4', className)}>
            ...
            <div className='flex justify-between'>
              ...
              <div className='flex flex-col gap-2 [&>*]:text-end'>
                <Typography variant='h6'>US $ 0.00</Typography>
                <Typography variant='span'>$ 0.00</Typography>
                <Typography variant='span'>$ __</Typography>
              </div>
            </div>
            <hr className='w-full' />
            <div className='flex justify-between'>
              <Typography variant='h6'>Total</Typography>
              <Typography variant='h6'>$ 534987</Typography>
            </div>
